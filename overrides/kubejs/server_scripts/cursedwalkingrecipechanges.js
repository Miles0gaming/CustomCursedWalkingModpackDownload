...
ServerEvents.recipes(event => {
    ...
    //Adds minigun motor recipe
    event.shaped(
      Item.of('pointblank:motor'),
      [
        'GCG',
        'GNG',
        'GRG'
    ...
    //Adds a more effecient gun metal recipie for post nether production
    event.custom({
      "type": "create:mixing",
      ...
      "results": [
        {"item": "pointblank:gunmetal_ingot", "count": 3}
      ]
    })
